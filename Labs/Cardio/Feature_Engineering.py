...
def blood_pressure(df):
    ...
    #Gränserna för varje kategori läser jag av från tabellen given från 'https://www.healthline.com/health/high-blood-pressure-hypertension#readings'
    #..genom att göra en funktion med alla dess intervall och logiska uttryck
